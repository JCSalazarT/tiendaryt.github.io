<?php 
	...
	const WEB_EMPRESA = "www.grupor&t.com";

	const DESCRIPCION = "La mejor tienda en línea con materiales de construcción.";
	const SHAREDHASH = "TiendaVirtual";

	//Datos Empresa
	const DIRECCION = "Huari, Perú";
	const TELEMPRESA = "+(01)7787845";
	const WHATSAPP = "+51920803111";
